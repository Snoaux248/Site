...
var DeleteChild = function(){
    document.getElementById("PageResults").classList.remove("showMainPlayer");
    document.getElementsByClassName("mainplayer")[0].children[0].children[0].children[0].children[0].children[0].src = "http://127.0.0.1:8000/Snow/MainPlayer/key?url=";
    resetURL();
}
