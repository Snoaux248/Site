...
function Dark_Mode_Toggle(){
    ...
    if(darkmode == true){
        document.querySelector('#StyleSheetControl1').href = "videos/css/SearchLinks-Light1.css";
        document.querySelector('#StyleSheetControl2').href = "videos/css/PopulateVideos-Light.css";
        ...
        document.querySelector('#StyleSheetControl1').href = "videos/css/SearchLinks-Dark1.css";
        document.querySelector('#StyleSheetControl2').href = "videos/css/PopulateVideos-Dark.css";
