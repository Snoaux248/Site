...
var initSortableList = (e) => {
    ...
    let nextSibling = siblings.find(sibling => {
      //console.log(items.offsetLeft, sibling ,sibling.offsetLeft, sibling.offsetWidth );
        let pos = Math.floor((e.clientX - ((window.innerWidth - document.querySelector('.LinksDiv').offsetWidth) / 2))/114);
...
var QuickLinkRedirect = function(){
  ...
  window.location.assign(page.QuickLinks_structure.structure[location].url);
}
...
var QuickLinkHover = function(){
  ...
  c.style.color = page.QuickLinks_structure.structure[location].title_hover;
  c.style.backgroundColor = page.QuickLinks_structure.structure[location].background_hover;
}
...
var QuickLinkHoverOut = function(){
  ...
  let c = p.querySelector("#LinksRedirect");
  c.style.color = page.QuickLinks_structure.structure[location].title_color;
  c.style.backgroundColor = page.QuickLinks_structure.structure[location].background_color;
}
...
var QuickLinkRemove = function(){
  ...
  setTimeout(() => {
    ...
    p.style.width = HyperlinkDivWidth;
    p.style.height = HyperlinkDivHeight;
   }, 200);
}
...
var QuickLinkAdd = function(){
  ...
  CurrentLocation = page.QuickLinks_structure.length;
}
...
var QuickLinkEdit = function(){
  ...
  document.getElementById("LinkAddTitle").value = page.QuickLinks_structure.structure[location].title;
  document.getElementById("LinkAddURL").value = page.QuickLinks_structure.structure[location].url;
  document.getElementById("LinkTColorPicker").value = page.QuickLinks_structure.structure[location].title_color;
  document.getElementById("LinkTHColorPicker").value = page.QuickLinks_structure.structure[location].title_hover;
  document.getElementById("LinkBGColorPicker").value = page.QuickLinks_structure.structure[location].background_color;
  document.getElementById("LinkBGHColorPicker").value = page.QuickLinks_structure.structure[location].background_hover;
...
document.getElementById("CreateLinkB").addEventListener("click", (e) => {
  ...
  p = document.querySelector('.LinksDiv');
  ...
  if(CreatorTitle == "Edit Link"){
    ...
    page.QuickLinks_structure.remove_by_location(CurrentLocation);
    var new_link = {
...
function CheckHyperlinkArrangment(){
  ...
  document.querySelector('.LinksDiv').style.width = HyperlinkDivWidth  + "px";
  ...
  if(PageState == 1){
    ...
    document.querySelector('.LinksDiv').style.height = HyperlinkDivHeight + "px";
  }else if(PageState == 2){
